...
func (msg *MsgCounter) ValidateBasic() error {
	...
	return errors.Wrap(sdkerrors.ErrInvalidSequence, "counter should be a non-negative integer")
}
...
func (msg *MsgKeyValue) ValidateBasic() error {
	if msg.Key == nil {
		return errors.Wrap(sdkerrors.ErrInvalidRequest, "key cannot be nil")
	}
	if msg.Value == nil {
